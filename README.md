...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/y1ea7ZWzY6)
...
```sh
npx nx serve online-shop
```

To create a production bundle:

```sh
npx nx build online-shop
```

To see all available targets to run for a project, run:

```sh
npx nx show project online-shop
```
